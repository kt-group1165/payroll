 ...
 * 単価表の無い 姉崎ムツミ は 総括表の本人給 (集計項目小計) を候補単価で再計算して決めた (2,100/1,750/1,550 で 23名中19名が1円一致、他の候補は 0 名)。
 * いわね は やわた と同じ職員 (総括表のパートが同一) なので やわた と同じ。既存の値が同じなら何もしない。
 */
...
const TARGET = {
  ...
  "1272400142": STD, // KT姉崎
  "1272400829": STD, // 姉崎ムツミ (総括表の小計から逆算)
  "1271103184": STD, // いわね (やわたと同じ)
