 ...
 *               E29 (無ければ B14) 今年度日当
 *   前年度の日当 = 1 つ前の年度のファイルの今年度日当 (無いときだけ B11 前年度日当)。
 *     B11 と食い違うことがあり、総括表は前年度ファイルの値を使う (おゆみ野 上野 2026-07: 8,722 = 総括表 / B11 は 8,932)
 * ★ 2026 年度は「有給管理簿」シートの値 (付与日数=繰越 / 日当 前年度・今年度) を入れ直した (scratchpad ledger.py → ledger2026.json)。
 *   個人シートの日当は総括表と食い違う人がいる (さつき 米倉 7,712 / 管理簿 906 = 総括表)。管理簿の値で 社員 224 件中 206 件一致。
